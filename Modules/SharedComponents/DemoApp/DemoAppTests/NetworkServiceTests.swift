...
class NetworkServiceTests: XCTestCase {
  ...
  func testConfigureService() {
    // GIVEN
    configurator.headers = ["Test": "App:TestApp; App-version:0.1; App-build:2427(f188b9fc); OS:iOS; OS-version:11.4; ID:C15D6DC8-6CDC-4BE7-82C9-90A39C92656C"]
    ...
    XCTAssertEqual(headers["Test"], "App:TestApp; App-version:0.1; App-build:2427(f188b9fc); OS:iOS; OS-version:11.4; ID:C15D6DC8-6CDC-4BE7-82C9-90A39C92656C")
  }
