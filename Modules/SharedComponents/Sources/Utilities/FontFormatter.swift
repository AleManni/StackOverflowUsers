...
public typealias TextStyle = (font: FontStyle, color: Colours)
...
extension FontFormatter {
   ...
   */
    public static func format(buttons: [UIButton], textStyle: TextStyle, for state: UIControl.State = .normal) {
    buttons.forEach {
  ...
  /**
   ...
   - parameter state:      The control state to style. By default it uses `UIControlState.normal`.
   */
    public static func format(button: UIButton, textStyle: TextStyle, for state: UIControl.State = .normal) {
